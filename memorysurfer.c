...
static const int32_t MSF_VERSION = 0x010001cb;
...
static enum Action action_seq[S_END+1][18] = {
  ...
  { A_SLASH, A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_RETRIEVE_MTIME, A_MTIME_TEST, A_TEST_DECK, A_LOAD_CARDLIST, A_SEND_CARD, A_END }, // S_SEND_CARD
          ...
          if (e == 0) {
            ...
            while ((act_c = action_seq[wms->seq][act_i++]) != A_END && e == 0) {
              ...
              case A_TOGGLE:
                ...
                break;
              case A_MOVE_CAT:
                assert(wms->ms.cat_t[wms->ms.deck_i].cat_used != 0 && wms->ms.cat_t[wms->ms.mov_deck_i].cat_used != 0);
                n_prev = -1;
