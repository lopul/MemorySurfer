...
static enum Action action_seq[S_END+1][14] = {
  ...
  { A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_RETRIEVE_MTIME, A_LOAD_CARDLIST, A_CHECK_RESUME, A_UPDATE_QA, A_UPDATE_HTML, A_DETERMINE_CARD, A_SYNC, A_END }, // S_QUESTION_SYNCED
  { A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_LOAD_CARDLIST, A_CHECK_RESUME, A_DETERMINE_CARD, A_END }, // S_QUESTION
  { A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_TEST_CAT_SELECTED, A_TEST_CAT_VALID, A_LOAD_CARDLIST, A_TEST_CARD, A_SHOW, A_CHECK_RESUME, A_END }, // S_SHOW
  { A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_TEST_CAT, A_LOAD_CARDLIST, A_TEST_CARD, A_REVEAL, A_CHECK_RESUME, A_END }, // S_REVEAL
  ...
  if (e == 0) {
    ...
    while ((bl = block_seq[wms->page][bl_i++]) != B_END && e == 0)
    {
      ...
      case B_PREFERENCES:
        ...
        break;
      case B_ABOUT:
        rv = printf("\t\t\t<h1 class=\"msf\">About MemorySurfer v1.0.1.62</h1>\n" 
