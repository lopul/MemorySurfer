  ...
  if (e == 0) {
    ...
    while ((bl = block_seq[wms->page][bl_i++]) != B_END && e == 0) {
      ...
      case B_EDIT:
        ...
        if (e == 0) {
          ...
          rv = printf("\t\t\t<h1 class=\"msf\">Editing</h1>\n"
                      ...
                      "\t\t\t<div class=\"msf-txtarea\"><textarea class=\"msf\" name=\"q\" rows=\"10\"%s>%s</textarea></div>\n"
          ...
          if (e == 0) {
            ...
            if (e == 0) {
              rv = printf("\t\t\t<div class=\"msf-txtarea\"><textarea class=\"msf\" name=\"a\" rows=\"10\"%s>%s</textarea></div>\n"
      ...
      case B_PREFERENCES:
        ...
        break;
      case B_ABOUT:
        rv = printf("\t\t\t<h1 class=\"msf\">About <a href=\"https://www.lorenz-pullwitt.de/MemorySurfer/\">MemorySurfer</a> v1.0.1.131</h1>\n"
