...
static const int32_t MSF_VERSION = 0x010001a9;
...
enum Mode { M_NONE = -1, M_DEFAULT, M_MSG_NO_DECK, M_MSG_SUSPEND, M_MSG_RESUME, M_CHANGE_PASSWD, M_ASK, M_RATE, M_EDIT, M_LEARN, M_SEARCH, M_SEND, M_MOVE, M_CARD, M_MOVE_DECK, M_CREATE_DECK, M_START, M_END };
...
static enum Action action_seq[S_END+1][17] = {
  ...
  { A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_RETRIEVE_MTIME, A_TEST_CAT, A_LOAD_CARDLIST_OLD, A_TEST_CARD, A_UPDATE_QA, A_READ_STYLE, A_STYLE_GO, A_SYNC, A_END }, // S_STYLE_GO
  ...
  { A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_RETRIEVE_MTIME, A_LOAD_CARDLIST_OLD, A_UPDATE_QA, A_UPDATE_HTML, A_PREVIOUS, A_SYNC, A_END }, // S_PREVIOUS
  { A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_RETRIEVE_MTIME, A_LOAD_CARDLIST_OLD, A_UPDATE_QA, A_UPDATE_HTML, A_NEXT, A_SYNC, A_END }, // S_NEXT
  { A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_RETRIEVE_MTIME, A_LOAD_CARDLIST_OLD, A_TEST_CARD, A_UPDATE_QA, A_UPDATE_HTML, A_SCHEDULE, A_SYNC, A_END }, // S_SCHEDULE
  { A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_RETRIEVE_MTIME, A_LOAD_CARDLIST_OLD, A_TEST_CARD, A_UPDATE_QA, A_UPDATE_HTML, A_SET, A_SYNC, A_END }, // S_SET
  { A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_RETRIEVE_MTIME, A_LOAD_CARDLIST_OLD, A_UPDATE_QA, A_UPDATE_HTML, A_CARD_ARRANGE, A_SYNC, A_END }, // S_CARD_ARRANGE
  ...
  { A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_RETRIEVE_MTIME, A_LOAD_CARDLIST_OLD, A_UPDATE_QA, A_UPDATE_HTML, A_SELECT_SEND_CAT, A_SYNC, A_END }, // S_SELECT_SEND_CAT
  ...
  { A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_RETRIEVE_MTIME, A_LOAD_CARDLIST_OLD, A_UPDATE_QA, A_UPDATE_HTML, A_SEARCH, A_SYNC, A_END }, // S_SEARCH_SYNCED
  { A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_RETRIEVE_MTIME, A_LOAD_CARDLIST_OLD, A_UPDATE_QA, A_SYNC, A_SEARCH, A_END }, // S_SEARCH_SYNC_QA
  ...
  { A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_RETRIEVE_MTIME, A_LOAD_CARDLIST_OLD, A_TEST_CARD, A_UPDATE_QA, A_UPDATE_HTML, A_PREVIEW, A_SYNC, A_READ_STYLE, A_END }, // S_PREVIEW_SYNC
  ...
  { A_SLASH, A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_RETRIEVE_MTIME, A_TEST_CAT, A_LOAD_CARDLIST_OLD, A_TEST_CARD, A_UPDATE_QA, A_PROCEED, A_SYNC, A_DETERMINE_CARD, A_READ_STYLE, A_CHECK_RESUME, A_END }, // S_PROCEED_SYNC_QA
  { A_SLASH, A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_RETRIEVE_MTIME, A_TEST_CAT, A_LOAD_CARDLIST_OLD, A_TEST_CARD, A_UPDATE_QA, A_ASK_SUSPEND, A_SYNC, A_END }, // S_ASK_SUSPEND
  { A_SLASH, A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_RETRIEVE_MTIME, A_TEST_CAT, A_LOAD_CARDLIST_OLD, A_TEST_CARD, A_UPDATE_QA, A_SUSPEND, A_SYNC, A_DETERMINE_CARD, A_READ_STYLE, A_CHECK_RESUME, A_END }, // S_SUSPEND
  { A_SLASH, A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_RETRIEVE_MTIME, A_TEST_CAT, A_LOAD_CARDLIST_OLD, A_TEST_CARD, A_UPDATE_QA, A_ASK_RESUME, A_SYNC, A_END }, // S_ASK_RESUME
  { A_SLASH, A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_RETRIEVE_MTIME, A_TEST_CAT, A_LOAD_CARDLIST_OLD, A_TEST_CARD, A_UPDATE_QA, A_RESUME, A_SYNC, A_DETERMINE_CARD, A_READ_STYLE, A_END }, // S_RESUME
  { A_SLASH, A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_LOAD_CARDLIST_OLD, A_HISTOGRAM, A_END }, // S_HISTOGRAM
  { A_SLASH, A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_RETRIEVE_MTIME, A_TEST_CAT, A_LOAD_CARDLIST_OLD, A_TEST_CARD, A_UPDATE_QA, A_SYNC, A_HISTOGRAM, A_END }, // S_HISTOGRAM_SYNC_QA
  { A_SLASH, A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_LOAD_CARDLIST_OLD, A_TABLE, A_END }, // S_TABLE
  { A_SLASH, A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_RETRIEVE_MTIME, A_TEST_CAT, A_LOAD_CARDLIST_OLD, A_TEST_CARD, A_UPDATE_QA, A_SYNC, A_TABLE, A_END }, // S_TABLE_SYNC_QA
          ...
          if (wms->from_page == P_FILE || wms->from_page == P_ABOUT) {
            ...
            if (e == 0) {
              if (wms->saved_mode == M_NONE) {
                ...
                e = wms->saved_mode != M_MSG_NO_DECK;
  ...
  if (e == 0) {
    ...
    while ((bl = block_seq[wms->page][bl_i++]) != B_END && e == 0) {
      ...
      case B_MSG:
        ...
        assert((wms->todo_main >= S_FILE && wms->todo_main <= S_END) || wms->mode != M_NONE);
            ...
            if (e == 0) {
              ...
              while ((act_c = action_seq[wms->seq][act_i++]) != A_END && e == 0) {
                ...
                case A_LOAD_CARDLIST:
                  ...
                  data_size = imf_get_size(&wms->ms.imf, cat_ptr->cat_cli);
                  assert(data_size >= 0 && wms->ms.card_l == NULL);
                  wms->ms.card_l = malloc(data_size);
                  e = wms->ms.card_l == NULL;
                  if (e == 0) {
                    e = imf_get(&wms->ms.imf, cat_ptr->cat_cli, wms->ms.card_l);
                    if (e == 0) {
