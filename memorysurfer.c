  ...
  if (e == 0) {
    ...
    while ((bl = block_seq[wms->page][bl_i++]) != B_END && e == 0)
    {
      ...
      case B_PREFERENCES:
        ...
        break;
      case B_ABOUT:
        printf("\t\t\t<h1>About MemorySurfer v1.0.0.24</h1>\n"
