...
static const int32_t MSF_VERSION = 0x010001c6;
...
static enum Action action_seq[S_END+1][18] = {
  ...
  { A_SLASH, A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_RETRIEVE_MTIME, A_TEST_DECK, A_LOAD_CARDLIST, A_TEST_CARD, A_UPDATE_QA_OLD, A_READ_STYLE, A_STYLE_GO, A_SYNC, A_END }, // S_STYLE_GO
  ...
  { A_GATHER, A_OPEN, A_READ_PASSWD, A_AUTH_TOK, A_GEN_TOK, A_RETRIEVE_MTIME, A_LOAD_CARDLIST_OLD, A_UPDATE_QA_OLD, A_DETERMINE_CARD, A_SYNC, A_READ_STYLE, A_CHECK_RESUME, A_END }, // S_QUESTION_SYNC_QA
